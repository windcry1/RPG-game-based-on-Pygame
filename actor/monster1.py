...
class Monster(pygame.sprite.Sprite):
    def __init__(self, pos_x, pos_y):
        ...
        self.pos_x = pos_x
        self.pos_y = pos_y
        self.walk_frames = actor.DirAction('monster1', '', '', 1, 4, True)
        self.width = 97 * 2
        self.height = 113 * 2
        self.hp = 100
        self.max_hp = 100
        self.attack = 25
        self.rect = pygame.Rect(self.pos_x - self.width // 4, self.pos_y - self.height // 4, self.width, self.height)
        self.crashed = False
        self.get = False
    ...
    def draw(self, surface: pygame.Surface, win_x, win_y):
        ...
        pygame.draw.rect(surface, (0, 0, 255),
                         pygame.Rect(self.pos_x - win_x + 16 - self.max_hp // 4 - 2, self.pos_y - win_y - 17,
                                     self.max_hp // 2 + 4, 14))
